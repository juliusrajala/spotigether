...
{
	if (region.aa.F === region.ag.F)
	{
		return 'on line ' + region.aa.F;
	}
	return 'on lines ' + region.aa.F + ' through ' + region.ag.F;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aS, request.ac, true);
		} catch (e) {
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aH: false, aJ: r.aJ, U: r.U, aO: r.aO, aS: r.aS, a2: r.a2, a4: r.a4, ac: r.ac}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aJ: $elm$http$Http$emptyBody, U: r.U, aO: _List_Nil, aS: 'GET', a2: $elm$core$Maybe$Nothing, a4: $elm$core$Maybe$Nothing, ac: r.ac});
};
...
var $author$project$Main$SpotifySong = F4(
	function (artist, track, id, album) {
		return {T: album, N: artist, V: id, R: track};
	});
...
var $author$project$Main$getNowPlaying = $elm$http$Http$get(
	{
		U: A2($elm$http$Http$expectJson, $author$project$Main$GotPlaying, $author$project$Main$songDecoder),
		ac: $author$project$Main$nowPlayingUrl
	});
var $jinjor$elm_debounce$Debounce$Debounce = $elm$core$Basics$identity;
var $jinjor$elm_debounce$Debounce$init = {n: _List_Nil, G: false};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{w: $elm$core$Maybe$Nothing, A: $jinjor$elm_debounce$Debounce$init, Z: '', H: false, B: _List_Nil},
...
var $author$project$Main$debounceConfig = function (debounceMsg) {
	return {
		a0: $jinjor$elm_debounce$Debounce$later(1000),
		a5: debounceMsg
	};
};
	...
	return $elm$http$Http$request(
		{
			...
			ac: $author$project$Main$postControlUrl
		});
};
	...
	function (config, a, _v0) {
		...
		var selfCmd = function () {
			...
			switch (_v1.$) {
				case 0:
					var offset = _v1.a;
					return d.G ? $elm$core$Platform$Cmd$none : A2(
		...
		return _Utils_Tuple2(
			newDebounce,
			A2($elm$core$Platform$Cmd$map, config.a5, selfCmd));
	});
...
var $author$project$Main$getSearchResults = function (input) {
	return $elm$http$Http$get(
		{
			U: A2($elm$http$Http$expectJson, $author$project$Main$GotSearch, $author$project$Main$searchDecoder),
			ac: $author$project$Main$searchSongsUrl + ('?query' + ('=' + input))
		});
};
...
var $author$project$Main$SetSearchActive = {$: 6};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Artisti: ' + track.N)
									])),
								A2(
								$elm$html$Html$span,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Albumi: ' + track.T)
									])),
								A2(
								$elm$html$Html$span,
								_List_fromArray(
						...
						if (_v0) {
							return A2(
								...
								_List_fromArray(
									[
										($elm$core$List$length(model.B) > 0) ? A2(
										$elm$html$Html$ul,
										_List_Nil,
										A2($elm$core$List$map, $author$project$Main$searchItem, model.B)) : A2(
										$elm$html$Html$span,
										_List_Nil,
										_List_fromArray(
											[
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{aR: $author$project$Main$init, a1: $author$project$Main$subscriptions, a6: $author$project$Main$update, a7: $author$project$Main$view});
